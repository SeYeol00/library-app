    ...
    )
{
    ...
    fun saveBookTest(){
        // given
        val request: BookRequest = BookRequest("이상한 나라의 엘리스", BookType.COMPUTER)
    ...
    fun loanBookFailTest(){
        ...
        bookRepository.save(Book.fixture("이상한 나라의 엘리스"))
        val savedUser = userRepository.save(User("박세열", 20))
        userLoanHistoryRepository.save(UserLoanHistory(savedUser,"이상한 나라의 엘리스",UserLoanStatus.LOANED))
        val request: BookLoanRequest = BookLoanRequest("박세열","이상한 나라의 엘리스")
